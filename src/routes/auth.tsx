      ...
      <div className="relative mx-auto flex min-h-screen max-w-md flex-col items-center justify-center px-6 py-12">
        ...
        <div className="w-full rounded-3xl glass-strong p-8">
          <h1 className="font-display text-3xl font-bold">
            {mode === "signin" ? "Bon retour parmi nous" : "Créez votre histoire"}
          </h1>
          <p className="mt-2 text-sm text-muted-foreground">
            {mode === "signin"
              ? "Connectez-vous pour retrouver vos matchs."
              : "Rejoignez la communauté premium de rencontres africaines."}
          </p>

          <button
            onClick={googleSignIn}
            disabled={loading}
            className="mt-6 flex w-full items-center justify-center gap-3 rounded-full bg-white px-5 py-3 text-sm font-semibold text-black transition hover:scale-[1.01] disabled:opacity-50"
          >
            ...
            {mode === "signup" && (
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full rounded-xl border border-border bg-background/60 px-4 py-3 text-sm outline-none transition focus:border-[oklch(0.66_0.24_5)]"
                  placeholder="Aminata"
                />
              </div>
            )}
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-xl border border-border bg-background/60 px-4 py-3 pl-10 text-sm outline-none transition focus:border-[oklch(0.66_0.24_5)]"
