...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Niou Waxtanne — Rencontres africaines premium" },
      { property: "og:description", content: "Rencontrez. Discutez. Aimez. La nouvelle référence des rencontres africaines modernes." },
